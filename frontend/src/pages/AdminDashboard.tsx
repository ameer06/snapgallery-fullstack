...
export const AdminDashboard: React.FC = () => {
  ...
  const [activeFilter, setActiveFilter] = useState<'all' | 'review' | 'published' | 'draft'>('all');
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-zinc-900 pb-16">
      <Navbar onNewEventClick={() => setShowCreateModal(true)} title="Studio" subtitle="Dashboard" />

      <div className="pt-20 px-4 sm:px-8 max-w-[1440px] mx-auto space-y-8">
